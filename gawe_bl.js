...
const get_regist_formdata = (identi, cookieidenti, browser_id, session, bebe, email, nama, authenticity)=> new Promise((resolve,reject)=>{
  fetch("https://accounts.bukalapak.com/register",{
    ...
    body: JSON.stringify({"access_token":"12n9yzQKGbP7yccftqZPlfa8rTxNAoh_dIoDD6KTMJiX6Q","user":{"email":`${email}`,"name":`${nama}`,"password":"Hamdan11","password_confirmation":"Hamdan11"},"authenticity_token":`${authenticity}`})
  })
  .then(res => res.json())
  .then(ress=>{
    resolve(ress)
...
(async()=>{
  ...
  // console.log(id)
   ...
   console.log(`
   ==================================================================
   ================ Auto Colok Bukalapak By. EMHAER ===================
   ==================================================================
   `)
   console.log(`
